...
class _AdvancedSearchScreenState extends State<AdvancedSearchScreen> with SingleTickerProviderStateMixin {
  ...
  List<dynamic> _getFilteredResults(ShopsProvider shopsProvider, String type) {
    ...
    return allItems.where((item) {
      ...
      if (_selectedRating != 'كل التقييمات') {
        final minRating = _selectedRating == '4 نجوم فأكثر' ? 4.0 :
                         _selectedRating == '3 نجوم فأكثر' ? 3.0 : 2.0;
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: ListView(
                children: [
                  _buildFilterSection('الفئة', _categories, _selectedCategory, (value) {
                    setState(() => _selectedCategory = value);
                  }),
                  _buildFilterSection('نطاق السعر', _priceRanges, _selectedPriceRange, (value) {
                    setState(() => _selectedPriceRange = value);
                  }),
                  _buildFilterSection('التقييم', _ratings, _selectedRating, (value) {
                    setState(() => _selectedRating = value);
                  }),
                  _buildFilterSection('ترتيب حسب', _sortOptions, _selectedSort, (value) {
